...
# 3. Standard Skills
Calculate the character's standard skills as usual.
...
- Allocate 100 points amongst the listed Standard Skills, the chosen Professional Skills and the Combat Style (if any). Each skill taken must receive at least 5% and maximally 15% during allocation.
...
From the selected profession, choose 3 professional skills and allocate 100 points. No skill can receive more than 15%.
...
If a character wishes to make a character with significantly more or less experience, they must do so with the consent of the GM and the other players.


# 7. Background and Passions
Optionally, determine the character's Background events, as well as the Social Class, Parents, Family Standing and Connections. Also, determine the character's starting money from their social class.

Beginning players are recommended to start with at least one, but up to three Passions, each based on two Characteristics, with a bonus of +40 to the first, +30 to the second and +20 to the third as per the Imperative Rules. 
