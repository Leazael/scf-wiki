...
The resonance itself is a mostly ununderstood phenomenon, however, it has been shown that when decomposed into its principle components, the main modes of any harmony produced in both the [[Resolite]] and its [[Resolite|Isomorphs]] are in fact orthogonal to the fibrational phase-spaces that make up the [[Luminiferous Æther]].
